...
import { OrganismeApiService } from 'projects/infosante-ng-core/src/lib/services/organisme-api.service';
...
export class RapportFusionUsagerPageComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private organsimeApiService: OrganismeApiService,
  ...
  ngOnInit() {
    ...
    this.subscriptions.add(
      forkJoin([
        ...
        this.organsimeApiService.getListeOrganismeOrderByActifNom() // 1
      ]).subscribe(results => {
