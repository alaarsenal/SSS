...
@Component({
  selector: 'app-editer-info-util-page',
  templateUrl: './editer-info-util-page.component.html',
  styleUrls: ['./editer-info-util-page.component.css']
})
export class EditerInfoUtilPageComponent implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    ...
    onListFichier(event) {
      this.fichierService.liste(Number(this.tableInforUtileDTO.identifiant), "SO_INFOR_UTILE").subscribe(data => {
