...
import { AccueilFicheAppelPageComponent, ConsultationFicheAppelAnterieurePageComponent, ConsultationFichePageComponent, DemandeEvaluationPageComponent, DetailUsagerPageComponent, FichiersAttachesPageComponent, PlanActionPageComponent, ProtocolesPageComponent, RapportFusionUsagerPageComponent, RechercherFicheAppelPageComponent, TerminaisonPageComponent } from "./components/pages";
...
const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [AuthGuardService],
    data: {
      requiredRoles: ['ROLE_SO_RAPPORT_AUD', 'ROLE_SO_RAPPORT_AUD_PROV']
    }
  },
  {
  ...
  },
  {
    ...
    data: {
      requiredRoles: ['ROLE_SO_APPEL_CONSULT']
    },
    children: [
      {
        path: "",
  ...
  },
  {
    ...
    canActivate: [AuthGuardService],
    data: {
      requiredRoles: ['ROLE_SO_APPEL_MODIF']
    },
    children: [
      {
        path: "",
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "plan-action",
            component: PlanActionPageComponent,
            canDeactivate: [AutoSaveGuardService],
            canActivate: [ConsultSuppFicheGuard],
          },
          {
  ...
  },
  {
    ...
    canActivate: [AuthGuardService],
    data: {
      requiredRoles: ['ROLE_SO_APPEL_RELANCE', 'ROLE_SO_APPEL_RELANCE_TOUS']
    },
  },
  {
  ...
  },
  {
    ...
    canActivate: [AuthGuardService],
    data: {
      requiredRoles: ['ROLE_SO_APPEL_RECH']
    },
  },
  {
    path: 'a-propos',
  ...
  },
  {
    ...
    canActivate: [AuthGuardService],
    data: {
      requiredRoles: ['ROLE_SO_APPEL_PILOTAGE']
    },
  },
  {
  ...
  },
  {
    ...
    component: EditerInfoUtilPageComponent,
    canActivate: [AuthGuardService],
    data: {
      requiredRoles: ['ROLE_SO_APPEL_PILOTAGE']
    },
