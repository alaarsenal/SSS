...
export class NoteComplementaireService {
  ...
  constructor(
    ...
    this.httpErrorHandler.createHandleError('NoteComplService'); //Important pour instancier correctement le service
  }
  ...
  getAttachedFilesToNote(idFicheAppel: number, idNote: number) {
